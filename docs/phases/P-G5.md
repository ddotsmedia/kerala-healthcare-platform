...
FEATURE: P-G5 — Revenue Dashboard
REPO PATH: /opt/kerala-healthcare-platform (VPS)
LOCAL: C:\websites\kerala-healthcare-platform


OBJECTIVE
If monetisation added: listing fees, featured
placements, subscription revenue tracking.

SCHEMA (additive migrations)
Migration 0117 — revenue_events table:
  id uuid PK,
  type VARCHAR(50),
  -- featured_listing|premium_subscription|
  --  job_post|bulk_import|api_access
...
ADMIN
apps/admin/app/analytics/revenue/page.js
  — Total revenue this month
  — Revenue by type
  — MRR trend
  Note: Actual payment integration deferred.
  This tracks manually-recorded revenue for now.

Smoke tests:
  Revenue event recorded
  Dashboard shows totals by type
